<template>
	<view v-if="goods_info.goods_name" class="goods-detail-container">
		...
		<uni-goods-nav :fill="true" :options="options" :buttonGroup="buttonGroup" @click="onClick" @buttonClick="buttonClick" /> </view>
	</view>
</template>
...
<script>
	...
	export default {
		...
		computed: { 
			// 调用 mapState 方法，把 m_cart 模块中的 cart 数组映射到当前页面中，作为计算 属性来使用
